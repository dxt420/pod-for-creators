var adonisPlaylist, currentPlaylistId, adonisPlayer = {}, playSong,
    adonisAllPlaylists = [],
...
jQuery(document).ready(function (a) {
    ...
    playSong = function (song) {
        ...
        var trackk = [{
            title: "Gimme Some Courage OO",
            artist: "Gunnar Olsen{#link7}",
            mp3: "https://firebasestorage.googleapis.com/v0/b/pod-music-eb445.appspot.com/o/files%2Fmediafiles%2Fsong_HNIWciF%20?alt=media&token=2",
            poster: "https://firebasestorage.googleapis.com/v0/b/pod-music-eb445.appspot.com/o/files%2Fmediafiles%2Fcover_art_PTMY4HI%20?alt=media&token=2"
        }]

        // adonisPlayer.jPlayer("setMedia", { title: "Fuck Love" }).jPlayer("play");
        // adonisPlayer.setPlaylist()
        adonisAllPlaylists[0] = trackk;
        adonisPlaylist.play(0);

        console.log(adonisPlaylist);

        console.log(adonisAllPlaylists);
    }
